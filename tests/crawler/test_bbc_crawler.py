"""
Test script for BBC News crawler
Tests the ability to crawl BBC News and extract content, saving results to JSON file
"""
...
from scrapers.spiders.bbc_spider import BBCSpider
...
class BBCTestPipeline:
    ...
    def __init__(self):
        ...
        self.output_file = os.path.join(
            ...
            f'bbc_test_results_{datetime.now().strftime("%Y%m%d_%H%M%S")}.json'
        )

    def open_spider(self, spider):
        """Called when spider is opened"""
        print(f"\n{'='*60}")
        print(f"BBC News Crawler Test Started")
        print(f"{'='*60}\n")
    ...
    def close_spider(self, spider):
        ...
        print(f"\n{'='*60}")
        print(f"BBC News Crawler Test Completed")
        print(f"{'='*60}")
